...
SECRET_KEY = 'django-insecure-p#t9g2byhpq$w973-(y6^3eju&4qmtx+4*cewi0^2i_di*bz(q'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # Nếu bạn có thư mục templates chung
        ],
        'APP_DIRS': True,  # Đảm bảo Django tìm kiếm template trong thư mục templates của ứng dụng
        'OPTIONS': {
            'context_processors': [
